...
export const Header = () => {
  ...
  return (
    <header className={`fixed w-full flex justify-between items-center text-black py-3 px-6 md:px-28 drop-shadow-md ${scrolled ? "bg-greenTheme shadow-lg z-10" : "bg-transparent"
      }`}>
