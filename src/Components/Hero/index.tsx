...
export const Hero = () => {
  return (
    ...
    lg:justify-center gap-2 bg-center bg-cover bg-no-repeat bg-bannerMobile md:bg-bannerDescktop md:bg-[-52rem_0] lg:bg-[-48rem_0] xl:bg-center lg:px-24">
      ...
      <a href="https://api.whatsapp.com/send/?phone=5522999599450&text&type=phone_number&app_absent=0" target="_blank"
        className="w-36 self-start text-lg bg-white px-6 py-3 mt-2 md:mt-4 rounded text-greenTheme font-bold">Saiba Mais!</a>
    </section>
  )
}
