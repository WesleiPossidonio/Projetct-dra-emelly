...
export const AboutMe = () => {
  ...
  return (
    <section className='w-full m-h-auto p-4 bg-center bg-fixed lg:bg-fixed bg-cover bg-parallaxDescktop bg-no-repeat relative min-h-mobile lg:min-h-0' id='about' style={{ height: '35rem' }}>
