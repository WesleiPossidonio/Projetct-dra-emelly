      ...
      <div className="container max-w-6xl mx-auto px-4 md:px-10 py-16">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-5 my-10">
          ...
          <div className="group border border-white rounded-md px-4 py-5 flex flex-col items-center 
            ...
            <img className='w-20 group-hover:hidden' src={ImageDivorceOne} alt="imagem de serviço" loading="lazy"/>
            <img className='hidden  w-20 group-hover:block' src={ImageDivorceTwo} alt="imagem de serviço" loading="lazy"/>
          ...
          <div className="group border border-white rounded-md px-4 py-5 flex flex-col items-center 
            ...
            <img className=' w-20 group-hover:hidden' src={InventarioOne} alt="imagem de serviço" loading="lazy" />
            <img className='hidden  w-20 group-hover:block' src={InventarioTwo} alt="imagem de serviço" loading="lazy" />
            <h2 className="text-white text-center group-hover:text-greenTheme text-lg md:text-xl font-bold">
          ...
          <div className="group border border-white rounded-md px-4 py-5 flex flex-col items-center 
            ...
            <img className='w-20 group-hover:hidden' src={ImageContractOne} alt="imagem de serviço" loading="lazy" />
            <img className='hidden  w-20 group-hover:block' src={ImageContractTwo} alt="imagem de serviço" loading="lazy" />
            <h2 className="text-white text-center group-hover:text-greenTheme text-lg md:text-xl font-bold">
          ...
          <div className="group border border-white rounded-md px-4 py-5 flex flex-col 
            ...
            transition ease-in-out duration-200" data-aos="zoom-in" data-aos-duration="1000">
            <img className='w-20 group-hover:hidden' src={SucessaoOne} alt="imagem de serviço" loading="lazy" />
            <img className='hidden  w-20 group-hover:block' src={SucessaoTwo} alt="imagem de serviço" loading="lazy" />
            <h2 className="text-white text-center group-hover:text-greenTheme text-lg md:text-xl font-bold">
          ...
          <div className="group border border-white rounded-md px-4 py-5 flex flex-col items-center 
            justify-center gap-3 hover:bg-white cursor-pointer hover:-translate-y-2 transition 
            ease-in-out duration-200" data-aos="zoom-in" data-aos-duration="1000">
            <img className=' w-20 group-hover:hidden' src={CasamentoOne} alt="imagem de serviço" loading="lazy" />
            <img className='hidden  w-20 group-hover:block' src={CasamentoTwo} alt="imagem de serviço" loading="lazy" />
          ...
          <div className="group border border-white rounded-md px-4 py-5 flex flex-col items-center 
            justify-center gap-3 hover:bg-white cursor-pointer hover:-translate-y-2 
            transition ease-in-out duration-200" data-aos="zoom-in" data-aos-duration="1000">
            <img className=' w-20 group-hover:hidden' src={PatrimonialOne} alt="imagem de serviço" loading="lazy" />
            <img className='hidden  w-20 group-hover:block' src={PatrimonialTwo} alt="imagem de serviço" loading="lazy" />
            <h2 className="text-white group-hover:text-greenTheme text-center text-lg md:text-xl font-bold">
