  ...
  return (
    <section className="w-full h-auto bg-primary">
      <div className="container mx-auto flex flex-col items-center justify-center gap-10 px-7 md:px-10 py-10 lg:py-24">
        <h1 className="text-xl text-white font-bold+">FAQ</h1>

        <Accordion type="single" collapsible className="w-full space-y-2">
          <AccordionItem value="item-1" className="bg-white px-2 rounded">
          ...
          <AccordionItem value="item-2" className="bg-white px-2 rounded">
          ...
          <AccordionItem value="item-3" className="bg-white px-2 rounded">
          ...
          <AccordionItem value="item-4" className="bg-white px-2 rounded">
          ...
          <AccordionItem value="item-5" className="bg-white px-2 rounded">
