...
export const Coments = () => {
  return (
    <section className="w-full h-auto flex items-center bg-primary" style={{ minHeight: '35rem' }}>
      <div className="container max-w-6xl mx-auto py-10 px-8 space-y-5 flex flex-col md:flex-row items-center justify-center gap-7">
